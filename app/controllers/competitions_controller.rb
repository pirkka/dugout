class CompetitionsController < ApplicationController
  def show
    @competition = Competition.includes(:league, :teams, :competition_teams, matches: { match_teams: :team }, contests: [:home_team, :away_team]).find_by(slug: params[:slug])
    if @competition.nil?
  ...
  def refresh
    ...
    elsif @competition.refresh_teams && @competition.refresh_matches && @competition.refresh_upcoming_matches && @competition.refresh_standings
